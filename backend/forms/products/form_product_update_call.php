...
<main class=" bg-secondary" style="height: calc(100vh - 114px);">
    <div class="flex justify-center p-10 items-center h-[100%]">
        <form action="/student023/shop/backend/forms/products/form_product_update.php" method="POST" class="flex flex-col gap-5 justify-center items-center bg-primary w-90 h-40 rounded-xl ">
