...
<main>
    <div class="flex justify-center p-10 bg-secondary">
        <form action="/student023/shop/backend/forms/form_product_delete.php" method="POST" class="flex flex-col gap-10 p-10 bg-primary w-300 rounded-xl items-center">
