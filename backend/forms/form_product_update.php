<?php 
    ...
    // DECLARE VARIABLES TO SAFE PRODUCT INFO
...
<main>
    <div class="flex justify-center p-10 bg-secondary">
        <form action="/student023/shop/backend/db/db_product_update.php" method="POST" class="flex flex-col gap-10 p-10 bg-primary w-300 rounded-xl">
