document.addEventListener('DOMContentLoaded', ()=> {
    ...
    searchProduct.addEventListener('click', () => {
        window.location.href = '/student023/shop/backend/forms/products/form_product_select_call.php'
    })

    deleteProduct.addEventListener('click', () => {
        window.location.href = '/student023/shop/backend/forms/products/form_product_delete_call.php'
    })

    updateProduct.addEventListener('click', () => {
        window.location.href = '/student023/shop/backend/forms/products/form_product_update_call.php'
    })
})